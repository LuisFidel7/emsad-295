...
<html class="no-js" lang="">
	...
	<?php session_start(); ?>
		...
		<link rel="stylesheet" href="css/estilos/aulas.css">
...
<section class="works">
	<div class="container animated-row">
		<div class="row">
			<div class="col-md-7">
				<div class="work-images animate" data-animate="fadeInLeft">
					<img width="100%" height="100%" src="img/salon.jpg" frameborder="0" allowfullscreen></img>
				</div>
			</div>
			<div class="col-md-5">
				<div class="work-text-full">
					<div class="work-text">
						<h2>SALONES DE CLASES</h2>
						<p>Contamos con un total de 10 salones de clases, con un aproximado de 35 sillas por aula.</p>
					</div>
				</div>
			</div>
		</div>
...
<section id="gallery" class="works">
	<div class="container">
		 <div class="row">
			  <div class="col-md-offset-1 col-md-10 col-sm-12 work-text">
				   <h2>Galeria de nuestras aulas nuevas</h2>
				   <p>las aulas en las que laboramos son prestadas temporalmente a las autoridades la colonia nuevo leon mientras se terminan de construir las nuestras.</p>
				   <p>Contaremos con 10 salones de clases repartidos entre todos los grados.</p>
				   <span></span>
				   <div class="col-md-6 col-sm-6">
						<div class="gallery-thumb">
							 <a href="img/galeria (3).jpg" class="image-popup">
								  <img src="img/galeria (3).jpg" class="img-responsive" alt="Gallery Image">
							 </a>
						</div>
				   </div>
				   ...
				   <div class="col-md-6 col-sm-6">
						<div class="gallery-thumb">
							 <a href="img/galeria (4).jpg" class="image-popup">
								  <img src="img/galeria (4).jpg" class="img-responsive" alt="Gallery Image">
							 </a>
						</div>
				   </div>
				   ...
				   <div class="col-md-6 col-sm-6">
						<div class="gallery-thumb">
							 <a href="img/galeria (5).jpg" class="image-popup">
								  <img src="img/galeria (5).jpg" class="img-responsive" alt="Gallery Image">
							 </a>
						</div>
				   </div>
				   ...
				   <div class="col-md-6 col-sm-6">
						<div class="gallery-thumb">
							 <a href="img/galeria (2).jpg" class="image-popup">
								  <img src="img/galeria (2).jpg" class="img-responsive" alt="Gallery Image">
							 </a>
						</div>
				   </div>
				   ...
				   <div class="col-md-6 col-sm-6">
						<div class="gallery-thumb">
							 <a href="img/galeria (1).jpg" class="image-popup">
								  <img src="img/galeria (1).jpg" class="img-responsive" alt="Gallery Image">
							 </a>
						</div>
				   </div>
				   ...
				   <div class="col-md-6 col-sm-6">
						<div class="gallery-thumb">
							 <a href="img/gallery-image6.jpg" class="image-popup">
								  <img src="img/gallery-image6.jpg" class="img-responsive" alt="Gallery Image">
							 </a>
						</div>
				   </div>
			  </div>
